...
})({"8EqHX":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "e8687eb93775bce1";
"use strict";
...
},{}],"kKwKL":[function(require,module,exports,__globalThis) {
(function initManualNextButton() {
    ...
    function getCurrentBaseUrl() {
        ...
        for(let i = segments.length - 1; i >= 0; i--){
            ...
            if ([
                ...
                if (baseIndex !== -1) return currentUrl.substring(0, baseIndex + segment.length + 1);
            }
        }
    ...
    nextBtn.addEventListener('click', ()=>{
        ...
        for(let i = 0; i < stepFiles.length; i++){
            ...
            if (relativePath === stepFile || relativePath.includes(stepFile.replace('.html', '/')) || stepFile === 'index.html' && (relativePath === '' || relativePath === 'index.html')) {
                currentIndex = i;
                break;
            }
        }
...
},{}]},["8EqHX","kKwKL"], "kKwKL", "parcelRequire94c2", {})

//# sourceMappingURL=Criminal.3775bce1.js.map
